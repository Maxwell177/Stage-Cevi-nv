...
namespace StageCeviDriesMaxwell2012
{
    public partial class Beginscherm : Form
    {
        ...
        private void btnParse_Click(object sender, EventArgs e)
        {
            ...
            {
                List<String> lijstTable = new List<string>();
                lijstTable.Add(dt.TableName);
                clbTable.CheckOnClick = true;
                clbTable.Items.AddRange(lijstTable.ToArray());
            }
        ...
        private void clbTable_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string tableName = "";
            tableName = clbTable.CheckedItems[0].ToString();
            DataTable dt = ds.Tables[tableName];
            foreach (DataColumn dc in dt.Columns)
            {
                List<String> lijstElements = new List<string>();
                lijstElements.Add(dc.ColumnName);
                clbElements.CheckOnClick = true;
                clbElements.Items.AddRange(lijstElements.ToArray());
            }
        }
